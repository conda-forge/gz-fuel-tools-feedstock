...
Once the `conda-forge` channel has been enabled, `gz-fuel-tools, libgz-fuel-tools` can be installed with `conda`:

```
conda install gz-fuel-tools libgz-fuel-tools
```

or with `mamba`:

```
mamba install gz-fuel-tools libgz-fuel-tools
```
