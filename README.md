...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gz-fuel-tools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gz-fuel-tools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
Once the `conda-forge` channel has been enabled, `gz-fuel-tools, gz-fuel-tools9, libgz-fuel-tools, libgz-fuel-tools9` can be installed with `conda`:

```
conda install gz-fuel-tools gz-fuel-tools9 libgz-fuel-tools libgz-fuel-tools9
```

or with `mamba`:

```
mamba install gz-fuel-tools gz-fuel-tools9 libgz-fuel-tools libgz-fuel-tools9
```
